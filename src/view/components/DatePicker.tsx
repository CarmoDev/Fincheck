...
import { capitalizeLetter } from "../../app/utils/capitalizeLetter";
    ...
    <DayPicker
      ...
      formatters={{
        formatCaption: (date, options) => {
          return (
            <span className="text-gray-900 tracking-[-0.408px] capitalize">
              {capitalizeLetter(format(date, "LLLL yyyy", options))}
            </span>
          );
        },
      }}
